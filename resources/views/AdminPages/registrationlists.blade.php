        ...
        <table id="regtbl" class="table table-hover" style="min-width: 100%;">
            <thead>
                <tr class="tableheader">
                    ...
                    <th class="tblheadcol" id="tbl-firstname-advocate">Förnamn Anhörig</th>
                    <th class="tblheadcol" id="tbl-lastname-advocate">Efternamn Anhörig</th>
            ...
            <tbody style="color: #606569;">
                @foreach ($registrations as $reg)
                    <tr>
                        ...
                        <td class="tblheadcol" id="tbl-edit">{{$reg->first_name_advocate}}</td>
                        <td class="tblheadcol" id="tbl-edit">{{$reg->last_name_advocate}}</td>
